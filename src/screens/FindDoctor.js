        ...
        return (
            ...
            <View style={{ flex: 1,margin: 10 }}>
                ...
                <View style={{ flex: 0.4, flexDirection: 'row', marginTop: 3}}>
                        <View style={{ flex:0.5, height: 50, backgroundColor: "#ccc", justifyContent: 'center' }}>
                    ...
                    <View style={{ flex: 0.5, height: 50, backgroundColor: "gray",justifyContent:'center' }}>
                            <TouchableOpacity onPress={this._onPressButton}>
                    ...
                    <View style={{ flex: 1, height: 50, backgroundColor: "#ccc", justifyContent: 'center' }}>
                            <TouchableOpacity onPress={this._onPressButton}>
            ...
            <View style={{borderBottomWidth:1,marginTop:10}}/>
                <View style={{ flex: 0.3}}>
                    <Text style={{ fontSize: 20}}>Browse Doctors By</Text>
                </View>
                <View style={{ flex: 0.4, flexDirection: 'row', marginTop: 3}}>
                    <View style={{ flex: 0.5, height: 50, backgroundColor: "#ccc", justifyContent: 'center' }}>
