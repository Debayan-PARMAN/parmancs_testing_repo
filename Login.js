    ...
    import { StyleSheet, View, Image, Text, Alert, TouchableOpacity, TextInput, CheckBox, Button } from 'react-native';
    export default class Log_In extends Component {
        ...
        render() {
            return (
                        ...
                        <View style={{flex:0.7, flexDirection:'row', borderBottomColor:'black', borderBottomWidth:1}}>
